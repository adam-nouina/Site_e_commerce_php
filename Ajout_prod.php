...
<body class="bg-light">
    ...
    ?>
     <h1 class="display-6 my-4 text-center">Ajouter un produit </h1>
     ...
     <?php
        if(isset($_POST['ajouter'])){
            ...
            if(!empty($titre) && !empty($description) && !empty($prix)){
                $enstock = !empty($enstock)?1:0;
                require_once "db.php";  
                $sqlst = $pdo->prepare("INSERT INTO produit VALUES(null,?,?,?,?,?,?)");
                $result = $sqlst->execute([$titre,$description,$prix,$enstock,$imgfilename,$solde]);
                var_dump(($result));
                if($result == true){
        ...
        <div class=" form-group mb-3">
            ...
            <input type="text" name="titre" class="form-control" aria-describedby="emailHelp" placeholder="Titre de produit ">
        </div>
        <div class="form-group mb-3">
        ...
        <div class="range-wrap">
            ...
            <input id="range" name="range" type="range" min="0" max="100" value="0" step="1">
        </div>
        <div class="form-group mb-3">
        ...
        <button type="submit" name="ajouter" class="w-100 btn btn-warning">Ajouter</button><br><br><br>
    </form>
    <script>
